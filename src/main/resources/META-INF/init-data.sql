insert into Student(id, firstname, lastname, matriculationId) values (1, 'Max', 'Mustermann', '123');
insert into Student(id, firstname, lastname, matriculationId) values (2, 'Moritz', 'Mustermann', '345');
