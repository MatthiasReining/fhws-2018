...
/**
 * Standalone.xml entry (<code>WILDFLY_HOME/standalone/configuration/standalone.xml</code>)
 * <pre>
 *  <datasource jndi-name="java:jboss/datasources/FHWSDS" pool-name="FHWSDS" enabled="true" use-java-context="true" statistics-enabled="true">
